...
const TestPdf = () => (
  <Document>
    <Page style={Mystyles.body} size="A4">
      <Text style={Mystyles.header} fixed>
        ~ Created with react-pdf ~
      </Text>
      <Text style={Mystyles.title}>Don Quijote de la Mancha</Text>
      <Text style={Mystyles.author}>Miguel de Cervantes</Text>
      ...
      <Text style={Mystyles.text}>
        ...
        antigua, rocín flaco hgjy galgo corredor. Una olla de algo más vaca que
      ...
      <Text style={Mystyles.subtitle} break>
      ...
      <Text style={Mystyles.pageNumber} render={({ pageNumber, totalPages }) => (
